...
test_that("Passing wrong parameters is handled correctly", {
	...
	expect_error(rtrunc(1, family = "nbinom", size = 1.4, prob = .1, mu = 10), msg)
	expect_error(rtrunc(1, family = "nbinom", size = 100, prob = 20, mu = 10), msg)
	expect_error(rtrunc(1, family = "nbinom", size = -10, prob = 20, mu = 10), msg)
	expect_error(rtrunc(1, family = "nbinom", size = 1.4, prob = .1, mu = 1i), msg)
	expect_error(rtrunc(1, family = "nbinom", size = 100, prob = 20, mu = 1i), msg)
	expect_error(rtrunc(1, family = "nbinom", size = -10, prob = 20, mu = 1i), msg)
	expect_error(rtruncnbinom(1, size = 1.4, prob = .1, mu = 10), msg)
	expect_error(rtruncnbinom(1, size = 100, prob = 20, mu = 10), msg)
	expect_error(rtruncnbinom(1, size = -10, prob = 20, mu = 10), msg)
	expect_error(rtruncnbinom(1, size = 1.4, prob = .1, mu = 1i), msg)
	expect_error(rtruncnbinom(1, size = 100, prob = 20, mu = 1i), msg)
	expect_error(rtruncnbinom(1, size = -10, prob = 20, mu = 1i), msg)
